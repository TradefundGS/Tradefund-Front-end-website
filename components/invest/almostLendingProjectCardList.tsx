import AlmostLendingProjectCard from "./almostLendingProjectCard";
...
export default function AlmostLendingCardList() {
	const { data, isLoading } = useProjects();
	// console.log(data);

	const projects = data?.almost_lending ?? [];
