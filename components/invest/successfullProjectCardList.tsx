import SuccessfullProjectCard from "./successfullProjectCard";
...
export default function SuccessfulProjectCardList() {
	const { data, isLoading } = useProjects();
	console.log(data);

	const projects = data?.successfulProject ?? [];
