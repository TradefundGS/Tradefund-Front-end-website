import EndingSoonProjectCard from "./endingSoonProjectCard";
...
export default function EndingSoonCardList() {
	const { data, isLoading } = useProjects();
	console.log(data);

	const projects = data?.projectsEndingSoon ?? [];
