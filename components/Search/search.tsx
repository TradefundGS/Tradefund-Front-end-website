...
const Search = () => {
  ...
  const { data, isLoading, isError, error, refetch, isFetching } = useAllProjects({
    filter: filters,
  });
  ...
  const filteredExploreChannel = useMemo(
    () => (searchTerm ? searchExploreChannel.map((result) => result.item) : availableProjects),
      ...
      <div className="bg-white">
        ...
        <main className="mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8 bg-gray-100">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Search</h2>
            ...
            <div className="mt-6 relative text-center mx-auto">
              <form className="mx-auto mt-6 sm:flex sm:max-w-md" onSubmit={(e) => e.preventDefault()}>
        ...
        <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 relative">
          <div className="lg:grid lg:grid-cols-4 lg:gap-x-8">
            ...
            <aside className="lg:col-span-1 lg:sticky lg:top-24 lg:h-screen hidden md:block">
              ...
              <FiltersForm setFilters={setFilters} filters={filters} />
            </aside>
...
{!isLoading && !isError && (
  <SearchProduct projects={filteredExploreChannel} isLoading={isFetching} />
)}
